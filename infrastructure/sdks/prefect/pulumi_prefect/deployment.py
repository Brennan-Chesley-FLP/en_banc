...
class DeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] manifest_path: The path to the flow's manifest file, relative to the chosen storage.
        ...
        if manifest_path is not None:
            ...
            pulumi.log.warn("""manifest_path is deprecated: Deprecated""")
        if manifest_path is not None:
...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["manifest_path"] = manifest_path
    ...
    @pulumi.getter(name="manifestPath")
    @_utilities.deprecated("""Deprecated""")
    def manifest_path(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The path to the flow's manifest file, relative to the chosen storage.
        """
        return pulumi.get(self, "manifest_path")
