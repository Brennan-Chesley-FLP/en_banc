...
class GetAccountResult:
    ...
    """
    def __init__(__self__, billing_email=None, created=None, domain_names=None, handle=None, id=None, link=None, location=None, name=None, settings=None, updated=None):
