...
class DeploymentScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] catchup: (Cloud only) Whether or not a worker should catch up on Late runs for the schedule.
        ...
        :param pulumi.Input[_builtins.float] max_active_runs: (Cloud only) The maximum number of active runs for the schedule.
        ...
        if catchup is not None:
            ...
            pulumi.log.warn("""catchup is deprecated: Deprecated""")
        if catchup is not None:
            pulumi.set(__self__, "catchup", catchup)
        if cron is not None:
        ...
        if max_active_runs is not None:
            warnings.warn("""Deprecated""", DeprecationWarning)
            pulumi.log.warn("""max_active_runs is deprecated: Deprecated""")
        if max_active_runs is not None:
            pulumi.set(__self__, "max_active_runs", max_active_runs)
...
class DeploymentSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["catchup"] = catchup
            ...
            __props__.__dict__["max_active_runs"] = max_active_runs
    ...
    @pulumi.getter
    @_utilities.deprecated("""Deprecated""")
    def catchup(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        (Cloud only) Whether or not a worker should catch up on Late runs for the schedule.
        """
        return pulumi.get(self, "catchup")
    ...
    @pulumi.getter(name="maxActiveRuns")
    @_utilities.deprecated("""Deprecated""")
    def max_active_runs(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        (Cloud only) The maximum number of active runs for the schedule.
        """
        return pulumi.get(self, "max_active_runs")
